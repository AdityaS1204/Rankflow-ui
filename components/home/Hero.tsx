...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 text-center pt-20">
      ...
      >
        <Link href="/docs/components/stacked-image-cards" className="relative overflow-hidden rounded-full border  border-zinc-300/30 shadow-2xs px-4 py-1.5 text-xs font-medium text-foreground cursor-pointer">
          {/* Shimmer sweep */}
          <motion.div
          ...
          />
          <div className="relative group flex gap-1">✦ Introducing new<span className="group-hover:text-amber-500 flex gap-1 transition-all duration-150"> Stacked Images <ArrowRightIcon className="group-hover:translate-x-1 transition-all duration-150" /> </span></div>
        </Link>
      </motion.div>
